...
<body>
	...
	<div id="container">
		...
		<section id="optionbuttoncontainer">
			...
			<div class="optionbutton"><a href="">Our Story</a></div>
		...
		<section id="featuredandnew">
			<div class="featuredandnewdev">
	...
	<script type="text/javascript">
		...
		bannerimg.style.backgroundImage = "url('_MG_3461.JPG')";
		var changeColor = function () {
			...
			if (this === buttonOne) {
				...
				transitionFunction(bannerimg , "linear .3s all");
				bannerimg.style.backgroundImage = "url('_MG_3574.JPG')";
				this.style.backgroundColor = "brown";
			} else if (this === buttonThree) {
				console.log("this is buttonThree");
				transitionFunction(bannerimg , "linear .3s all");
				bannerimg.style.backgroundImage = "url('_MG_3587.JPG')";
				this.style.backgroundColor = "brown";
			} else if (this === buttonFour) {
				console.log("this is buttonFour");
				transitionFunction(bannerimg , "linear .3s all");	
				bannerimg.style.backgroundImage = "url('_MG_3601.JPG')";
				this.style.backgroundColor = "brown";
			} else if (this === buttonFive) {
				console.log("this is buttonFive");
				transitionFunction(bannerimg , "linear .3s all");
				bannerimg.style.backgroundImage = "url('_MG_3618.JPG')";
				this.style.backgroundColor = "brown";
			}
		};
